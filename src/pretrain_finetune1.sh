...
model_path='/path/output/1e-4-o_madr-mul-softmax-a01-fix'
output_path='/path/output/1e-4-o_madr-mul-softmax-a01-fix/f1=sh#f2=con-no#f3=madr'
bert_dir='/path/downloads/bert-base-uncased'
pretrain_model_name_or_path=$model_path
gating_type='first-k:with-cls'

gpu_id=1

doc_query_e2468=(checkpoint-27126 checkpoint-30140)

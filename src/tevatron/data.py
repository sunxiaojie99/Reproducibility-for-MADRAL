...
class PretrainPreProcessor:
    ...
    def __call__(self, example):
        ...
        if self.data_args.pretrain_type in ['mlm', 'condenser']:
            ...
            elif prompt_type == 'only-brand':
                aspect_template = '[unused1][text_b][SEP][unused3][text_d]'
                prompt_dict = {
                    'brand': '[text_b]',
                    'text': '[text_d]',
                }  # 每个字段，在aspect_template中对应的占位符
            ...
            elif prompt_type == 'only-color':
                aspect_template = '[unused2][text_c][SEP][unused3][text_d]'
                prompt_dict = {
                    'color': '[text_c]',
                    'text': '[text_d]',
                }  # 每个字段，在aspect_template中对应的占位符
            ...
            elif prompt_type == 'only-cate':
                aspect_template = '[unused0][text_a][SEP][unused3][text_d]'
                prompt_dict = {
                    'cat': '[text_a]',
                    'text': '[text_d]',
                }  # 每个字段，在aspect_template中对应的占位符
        ...
        elif self.data_args.pretrain_type in ['mtbert', 'madr']:
            if self.is_concat == 'yes':
                text = '[unused0]' + cat \
                    + '[unused1]' + brand \
                    + '[unused2]' + color \
...
class PretrainDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        elif self.pretrain_type in ['mtbert', 'madr']:
            tok_text = instance["tokenized_text"]
            inputs = self.create_one_example(tok_text, max_length=max_length)
            all_tokenize_list = inputs['input_ids'][1:-1]
            if len(all_tokenize_list) != 0:
...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, item) -> Tuple[BatchEncoding, List[BatchEncoding]]:
        ...
        elif self.is_concat == 'concat-behind':
            pos_psg = pos_detail['product_title'] + [102] + pos_detail['product_description'] \
                + [102] + pos_detail['product_bullet_point'] + [102] + \
                [1] + cat_list + [2] + pos_detail['product_brand'] + [3] + pos_detail['product_color']
        elif self.is_concat == 'only-brand':
            pos_psg = [2] + pos_detail['product_brand'] \
                + [102] + [4] + pos_detail['product_title'] \
                + [102] + pos_detail['product_description'] \
                + [102] + pos_detail['product_bullet_point']
        elif self.is_concat == 'only-color':
            pos_psg = [3] + pos_detail['product_color'] \
                + [102] + [4] + pos_detail['product_title'] \
                + [102] + pos_detail['product_description'] \
                + [102] + pos_detail['product_bullet_point']
        elif self.is_concat == 'only-cate':
            pos_psg = [1] + cat_list \
                + [102] + [4] + pos_detail['product_title'] \
                + [102] + pos_detail['product_description'] \
                + [102] + pos_detail['product_bullet_point']
        elif self.is_concat == 'three-prompt-no':
            pos_psg = [1] + [] \
                + [2] + [] \
                + [3] + [] \
                + [102] + [4] + pos_detail['product_title'] \
        ...
        for idx, neg_psg in enumerate(negs_text):
            ...
            if self.is_concat == 'yes':
                ...
                neg_txt = neg_detail['product_title'] + [102] + neg_detail['product_description'] \
                    + [102] + neg_detail['product_bullet_point'] + [102] + \
                    [1] + cat_list + [2] + neg_detail['product_brand'] + [3] + neg_detail['product_color']
            elif self.is_concat == 'only-brand':
                neg_txt = [2] + neg_detail['product_brand'] \
                    + [102] + [4] + neg_detail['product_title'] \
                    + [102] + neg_detail['product_description'] \
                    + [102] + neg_detail['product_bullet_point']
            elif self.is_concat == 'only-color':
                neg_txt = [3] + neg_detail['product_color'] \
                    + [102] + [4] + neg_detail['product_title'] \
                    + [102] + neg_detail['product_description'] \
                    + [102] + neg_detail['product_bullet_point']
            elif self.is_concat == 'only-cate':
    ...
    def __getitem__(self, item) -> Tuple[str, BatchEncoding]:
        ...
        if self.is_query is False:  # for doc
            ...
            if self.is_concat == 'yes':
                ...
                text = product_title + [102] + product_description \
                    + [102] + product_bullet_point + [102] + \
                    [1] + cat_list + [2] + product_brand + [3] + product_color
            elif self.is_concat == 'only-brand':
                text = [2] + product_brand \
                    + [102] + [4] + product_title \
                    + [102] + product_description \
                    + [102] + product_bullet_point
            elif self.is_concat == 'only-color':
                text = [3] + product_color \
                    + [102] + [4] + product_title \
                    + [102] + product_description \
                    + [102] + product_bullet_point
            elif self.is_concat == 'only-cate':

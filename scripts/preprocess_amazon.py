...
# 读取原始的数据集
import pandas as pd
df_examples = pd.read_parquet('/path/attempt-code/downloads/amazon_ori/shopping_queries_dataset_examples.parquet')
df_products = pd.read_parquet('/path/attempt-code/downloads/amazon_ori/shopping_queries_dataset_products.parquet')
df_sources = pd.read_csv("/path/attempt-code/downloads/amazon_ori/shopping_queries_dataset_sources.csv")
...
# with jsonlines.open("/path/attempt-code/downloads/amazon_larger_version/amazon_corpus.jsonl", 'w') as w:
...
with jsonlines.open("/path/attempt-code/downloads/amazon_larger_version/train_query.jsonl", 'w') as w:

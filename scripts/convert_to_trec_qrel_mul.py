...
# python /path/attempt-code/scripts/convert_to_trec_qrel_mul.py --qrel_file /path/attempt-code/downloads/amazon_smaller_version/dev_qrel.txt
# python /path/attempt-code/scripts/convert_to_trec_qrel_mul.py --qrel_file /path/attempt-code/downloads/amazon_smaller_version/test_qrel_detail.txt